...
<body>
    <header class="bg-blue-400">
        <nav>
            <ul class="flex">
                <li>
                    <a href="../../index.html" button type="submit" class="p-3 text-white bg-purple-700 rounded" button>Home</a>
                </li>
            </ul>
            <form action="../controller/Product.php?operation=insert" method="POST">
                ...
                <article class="flex justify-center mt-3">
                    <button type="submit" class="p-3 text-white bg-purple-700 rounded">Cadastrar</button>
                </article>
            </form>
        </nav>
    </header>
